...
LinkList Union(LinkList *la,LinkList *lb);//求两个递增链表的公共部分，并存放在链表A中
...
LinkList List_TailInsert(LinkList *list){ //注意沙雕问题，不要马虎
    LNode *tail,*s;
    ElemType e;
    InitList(list);
    tail=*list;
